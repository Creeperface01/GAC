...
import GTCore.player.GTSynapsePlayer
 ...
 * @author CreeperFace
 */
class GTSynapseCheatPlayer(interfaz: SourceInterface, entry: SynapseEntry, clientID: Long?, ip: String, port: Int) : GTSynapsePlayer(interfaz, entry, clientID, ip, port), ICheatPlayer {
